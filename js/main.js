...
$(window).on("scroll touchmove", function() {
	...
	$("a[name]").each(function() {
		if (scrollPos > $(this).offset().top - yDiff - 50) {
...
$(document).ready(function() {
	...
	$(".main-menu-wrapper").click(function (e) {
		...
		if (!$(e.target).hasClass("main-menu-wrapper-inner") && !$(e.target).parents().hasClass("main-menu-wrapper-inner")) {
	...
	$(".nav-slider").each(function () {
		...
		var navSlider = $(this),
				sliderLink = $(this).closest(".nav-slider-wrapper").find(".nav-links a");

		navSlider.on("beforeChange", function(event, slick, currentSlide, nextSlide) {

			var activeItem = sliderLink.closest(".nav-links").find(".active");


			var curItem = sliderLink.filter(function () {

				return $(this).closest("li").prevAll().length == nextSlide;
		...
		sliderLink.on("click", function () {
			...
			var curItem = $(this),
				activeItem = $(this).closest(".nav-links").find(".active");

			if (!curItem.hasClass("active")) {

				navSlider.slick("slickGoTo", curItem.closest("li").prevAll().length);
	...
	$("body").on("click", ".zone-popup .close-popup", function () {

		$(".zone-popup").fadeOut(150);

	});


	$("body").on("click", ".zones-pin", function () {

		var curPopup = $(".zone-popup"),
				popupContent = curPopup.find(".popup-content");
	...
	$(".page-section-home-zones .zones-pin").click(function () {
	...
	$("body").on("click", ".ajax-link", function () {
		...
		curTarget.addClass("loading").css({

			height: curTarget.outerHeight()
	...
	$("body").on("click", function(e) {
		if ($("#md-indicator").css("display") == "block" && !$(e.target).hasClass("navbar-wrapper") && !$(e.target).parents().hasClass("navbar-wrapper") && !$(e.target).hasClass("navbar-trigger") && !$(e.target).parents().hasClass("navbar-trigger") && !$(e.target).hasClass("header-btn-menu") && !$(e.target).parents().hasClass("header-btn-menu")) {
...
function slickResponsive() {
	...
	if ($("#mobile-indicator").css("display") == "block") {
		...
		if (!$(".section-top-dir .section-header-ul").hasClass("slick-initialized")) {

			$(".section-top-dir .section-header-ul").slick({
				slidesToShow: 1,
				slidesToScroll: 1,
				speed: 500,
				rows: 0,
		...
		if (!$(".main-nav").hasClass("slick-initialized")) {

			$('.main-nav').on('afterChange', function(event, slick, currentSlide){
		...
		if ($(".section-top-dir .section-header-ul").hasClass("slick-initialized")) {
			...
			$(".section-top-dir .section-header-ul").slick("unslick");

		}

		if ($(".main-nav").hasClass("slick-initialized")) {

			$(".main-nav").slick("unslick");
...
function fixedArticleHeader() {

	$(".section-top-fixed .section-top-bg").css({

		minHeight: $(".section-top").outerHeight()
